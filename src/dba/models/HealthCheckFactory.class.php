...
class HealthCheckFactory extends AbstractModelFactory {
  ...
  function getNullObject() {
    $o = new HealthCheck(-1, null, null, null, null, null, null, null, null);
    return $o;
  }
  ...
  function createObjectFromDict($pk, $dict) {
    $o = new HealthCheck($dict['healthCheckId'], $dict['time'], $dict['status'], $dict['checkType'], $dict['hashtypeId'], $dict['crackerBinaryId'], $dict['expectedCracks'], $dict['attackCmd'], $dict['agentIds']);
    return $o;
  }
