...
class AgentFactory extends AbstractModelFactory {
  ...
  function createObjectFromDict($pk, $dict) {
    $o = new Agent($dict['agentId'], $dict['agentName'], $dict['uid'], $dict['os'], $dict['devices'], $dict['cmdPars'], $dict['ignoreErrors'], $dict['isActive'], $dict['isTrusted'], $dict['token'], $dict['lastAct'], $dict['lastTime'], $dict['lastIp'], $dict['userId'], $dict['cpuOnly'], $dict['clientSignature'], $dict['cpuTemp'], $dict['cpuUtil'], $dict['deviceUtil'], $dict['mac']);
    return $o;
  }
