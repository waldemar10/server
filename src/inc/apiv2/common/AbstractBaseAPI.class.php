 ...
 * Retrieve permissions based on expand section
  */
  ...
  protected static $acl_mapping = array(
    ...
    DAccessControl::MANAGE_AGENT_ACCESS => array(Agent::PERM_READ, Agent::PERM_UPDATE, Agent::PERM_DELETE, Agent::PERM_SHUTDOWN, Agent::PERM_WOL,
                                                // src/inc/defines/agents.php
                                                AgentStat::PERM_CREATE, AgentStat::PERM_READ, AgentStat::PERM_UPDATE, AgentStat::PERM_DELETE, AgentStat::PERM_SHUTDOWN, AgentStat::PERM_WOL,
